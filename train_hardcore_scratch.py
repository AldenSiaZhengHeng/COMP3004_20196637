# This file is used to train the TD3 agent from scratch in BipedalWalker-v3 Hardcore version
...
def main(seed):
    ...
    models_path = 'models'
    runs_path = 'runs/exp_hardcore_scratch'
    ...
    writer = SummaryWriter(log_dir='runs/exp_hardcore_scratch')
    ...
    for episode in range(Max_episode):
        ...
        if (episode+1)%save_interval==0:
            model.save(str(episode + 1) + "-hardcore-scratch")
        ...
        if(np.mean(scores[-20:]) >= 300):
            model.save("_final_" + env_id + "-hardcore-scratch")
            break
        ...
        with open(env_id + "-hardcore-scratch-data.csv", "a", newline="") as f:
    ...
    plt.grid()
    plt.savefig("models/" + 'train_BipedalWalker-v3-hardcore-scratch.png')
    plt.show() 
